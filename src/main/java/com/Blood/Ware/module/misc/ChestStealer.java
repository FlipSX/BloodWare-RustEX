...
import com.Blood.Ware.utils.TimerUtil;
...
public class ChestStealer extends Module {
    ...
    public ChestStealer() {
        super("ChestStealer", Category.OUTHER);

        BloodWare.instance.settingsManager.rSetting(new Setting("Delay", this, 50, 0, 200, true));
        BloodWare.instance.settingsManager.rSetting(new Setting("Chest", this, true));
        BloodWare.instance.settingsManager.rSetting(new Setting("EnderChest", this, false));
        BloodWare.instance.settingsManager.rSetting(new Setting("Aura", this, false));
        BloodWare.instance.settingsManager.rSetting(new Setting("AuraRange", this, 4, 1, 10, false));
        BloodWare.instance.settingsManager.rSetting(new Setting("AuraWalls", this, true));
    }

    @SubscribeEvent
    public void onPlayerTick(TickEvent.PlayerTickEvent e) {
        double delay = BloodWare.instance.settingsManager.getSettingByName(this, "Delay").getValDouble();
        boolean aura = BloodWare.instance.settingsManager.getSettingByName(this, "Aura").getValBoolean();
        double aurarange = BloodWare.instance.settingsManager.getSettingByName(this, "AuraRange").getValDouble();
        boolean walls = BloodWare.instance.settingsManager.getSettingByName(this, "AuraWalls").getValBoolean();
    ...
    private boolean IsValidBlockPos(BlockPos pos) {
        boolean chest = BloodWare.instance.settingsManager.getSettingByName(this, "Chest").getValBoolean();
        boolean enderchest = BloodWare.instance.settingsManager.getSettingByName(this, "EnderChest").getValBoolean();
