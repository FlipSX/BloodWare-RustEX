...
public class BlockStateContainerVisitor extends ClassVisitor {
    ...
    public static class ShouldSideBeRenderedVisitor extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == IRETURN) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "ru/internali/utils/EventFactory", "shouldSideBeRendered", "(Lnet/minecraft/block/state/IBlockState;Lnet/minecraft/world/IBlockAccess;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/util/EnumFacing;)Z", false);
            }
    ...
    public static class GetAmbientOcclusionLightValueVisitor extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == FRETURN){
                mv.visitVarInsn(ALOAD, 0);
                mv.visitMethodInsn(INVOKESTATIC, "ru/internali/utils/EventFactory", "getAmbientOcclusionLightValue","(Lnet/minecraft/block/state/IBlockState;)F", false);
            }
