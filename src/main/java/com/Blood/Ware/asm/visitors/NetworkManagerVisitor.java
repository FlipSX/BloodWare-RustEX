...
public class NetworkManagerVisitor extends ClassVisitor {
    ...
    public static class SendPacketVisitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "ru/internali/utils/EventFactory", "onSendPacket", "(Lnet/minecraft/network/Packet;)Lnet/minecraft/network/Packet;", false);
    ...
    public static class ChannelRead0Visitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "ru/internali/utils/EventFactory", "onReceivePacket", "(Lnet/minecraft/network/Packet;)Lnet/minecraft/network/Packet;", false);
